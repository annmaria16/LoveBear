...
input[type=text],input[type=password]{width:100%;padding:10px;margin:8px 0;border:1px solid #f0d7df;border-radius:8px;transition:border-color .3s}
...
<?php if (!empty($auth->error)): ?>
  <div class="error"><?= htmlspecialchars($auth->error) ?></div>
<?php endif; ?>

<form method="post" id="loginForm">
  <input type="text" id="username" name="username" placeholder="Registered Email" required>
